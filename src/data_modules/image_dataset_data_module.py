...
class ImageDatasetDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self, drop_last=True, shuffle=True) -> DataLoader:
        assert self.__train_dataset is not None
        print(f'Creating train dataloader with batch size {self.train_batch_size}...')
    ...
    def val_dataloader(self) -> DataLoader:
        ...
        print(f'Creating validation dataloader with batch size {self.validation_batch_size}...')
        return DataLoader(self.__validation_dataset, batch_size=self.validation_batch_size, shuffle=True,
