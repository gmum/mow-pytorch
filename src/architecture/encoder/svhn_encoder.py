...
from modules.cnn_encoder_block import CnnEncoderBlock
import torch
...
class Encoder(nn.Module):
    ...
    def forward(self, input_images: torch.Tensor):
        assert input_images.size(1) == 3 and input_images.size(2) == 32 and input_images.size(3) == 32, input_images.size()
