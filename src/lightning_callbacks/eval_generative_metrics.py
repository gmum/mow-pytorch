...
class EvalGenerativeMetrics(Callback):
    ...
    def __init__(self, data_module: ImageDatasetDataModule, enable_kid: bool):
        super().__init__()
        self.__data_module = data_module
        self.__enable_kid = enable_kid

    def on_validation_epoch_end(self, trainer: Trainer, pl_module: BaseGenerativeModule) -> dict[str, float]:
